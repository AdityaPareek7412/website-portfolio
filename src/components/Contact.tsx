      ...
      <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                {[
                  { icon: Mail, label: "adityapareek7412@gmail.com", href: "mailto:adityapareek7412@gmail.com", color: "from-red-400 to-pink-400" },
                  { icon: Phone, label: "+91 8114415202", href: "tel:+918114415202", color: "from-green-400 to-blue-400" },
                  { icon: Github, label: "GitHub Profile", href: "https://github.com/AdityaPareek7412", color: "from-gray-400 to-gray-600" },
                  { icon: Linkedin, label: "LinkedIn Profile", href: "https://www.linkedin.com/in/aditya-pareek-/", color: "from-blue-400 to-blue-600" }
                ].map((social, index) => (
                  <motion.a
                    key={social.label}
                    href={social.href}
        ...
        >
          <p className="text-gray-500">
            © 2025 Aditya Pareek. Engineering the future with AI.
          </p>
        </motion.div>
      </div>
    </section>
